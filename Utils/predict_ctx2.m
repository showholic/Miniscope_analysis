function [accuracyA,accuracyB]=predict_ctx2(sig,session_start,protocol,ms_ts)

    ctx_dur=280;
    sig_ctxBpre=sig(:,session_start((strcmp(protocol,'preB')==1)):session_start((strcmp(protocol,'preB')==1))+ctx_dur*10-1);
    sig_ctxApre=sig(:,session_start((strcmp(protocol,'preA')==1)):session_start((strcmp(protocol,'preA')==1))+ctx_dur*10-1);
    sig_ctxBpost=sig(:,session_start((strcmp(protocol,'postB')==1)):session_start((strcmp(protocol,'postB')==1))+ctx_dur*10-1);
    sig_ctxApost=sig(:,session_start((strcmp(protocol,'postA')==1)):session_start((strcmp(protocol,'postA')==1))+ctx_dur*10-1);
